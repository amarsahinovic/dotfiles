...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- Lexical can't be installed via Mason, so we have to add the config manually
      ...
      local lexical_opts = {}
      lexical_opts.capabilities = vim.tbl_deep_extend('force', {}, capabilities, lexical_opts.capabilities or {})
      lspconfig.lexical.setup(lexical_opts)
    end,
  },
